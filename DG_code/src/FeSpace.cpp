...
const FeElement& FeSpace::getFeElement(unsigned i) const
{
  return feElements_[i];
}

const FeFaceInt& FeSpace::getFeFaceInt(unsigned i) const
{
  return feFacesInt_[i];
}

const FeFaceExt& FeSpace::getFeFaceExt(unsigned i) const
{
  return feFacesExt_[i];
}

unsigned FeSpace::getFeElementsNo() const
{
  return feElements_.size();
}

unsigned FeSpace::getFeFacesIntNo() const
{
  return feFacesInt_.size();
}

unsigned FeSpace::getFeFacesExtNo() const
{
  return feFacesExt_.size();
}

std::vector<FeElement>::const_iterator FeSpace::feElementsCbegin() const
{
  return feElements_.cbegin();
}

std::vector<FeElement>::const_iterator FeSpace::feElementsCend() const
{
  return feElements_.cend();
}

std::vector<FeFaceInt>::const_iterator FeSpace::feFacesIntCbegin() const
{
  return feFacesInt_.cbegin();
}

std::vector<FeFaceInt>::const_iterator FeSpace::feFacesIntCend() const
{
  return feFacesInt_.cend();
}

std::vector<FeFaceExt>::const_iterator FeSpace::feFacesExtCbegin() const
{
  return feFacesExt_.cbegin();
}

std::vector<FeFaceExt>::const_iterator FeSpace::feFacesExtCend() const
{
